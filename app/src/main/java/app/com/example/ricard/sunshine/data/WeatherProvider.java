...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        sURIMatcher.addURI(CONTENT_AUTHORITY,WeatherContract.PATH_LOCATION,LOCATION);
        sURIMatcher.addURI(CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER,WEATHER);
        sURIMatcher.addURI(CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER+"/*",WEATHER_WITH_LOCATION);
        sURIMatcher.addURI(CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER+"/*"+"/#",WEATHER_WITH_LOCATION_AND_DATE);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case WEATHER_WITH_LOCATION: {
                ...
                //int type = cursor.getType(6);
                //Log.e(LOG_TAG, "This is " + retCursor.getColumnCount());
                //Double updatedtemp = retCursor.getDouble(6);
                //Log.e(LOG_TAG, "2: Updated max temp: " + updatedtemp);
                break;
            }
            // "weather"
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case WEATHER: {
                ...
                numberRowsDeleted = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);

                break;
            }
            case LOCATION: {
                numberRowsDeleted = db.delete(WeatherContract.LocationEntry.TABLE_NAME, selection, selectionArgs);
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER: {
                ...
                numberRowsUpdated = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection, selectionArgs);

                break;
            }
            case LOCATION: {
                numberRowsUpdated = db.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
